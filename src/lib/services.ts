...
export const services: Service[] = [
  {
    ...
    intro: [
      ...
      "Lakeside Outdoor Services has kept Watertown-area businesses open through winter since 2010. We build seasonal snow plowing programs around your property, your peak hours, and your risk — then execute them with digitally dispatched trucks, defined trigger depths, and documented service so you always know your site was handled.",
    ],
    highlights: [
      {
        title: "Cleared before you open",
        desc: "We plow to your schedule — early-morning clearing so lots and entrances are ready before your first customer or shift arrives.",
      },
      {
      ...
      },
      {
        ...
        desc: "Defined snow-depth triggers mean we're on-site during and after every storm — not waiting for a phone call.",
      },
      {
    ...
    faqs: [
      ...
      {
        q: "What snow depth triggers a plow?",
        a: "We set a trigger depth with you up front — commonly 2 inches for commercial lots, less for high-traffic or liability-sensitive sites like medical offices. Once accumulation hits your trigger, we're dispatched automatically. No phone call required.",
      },
      {
  ...
  },
  {
    ...
    highlights: [
      {
        ...
        desc: "Depth-triggered dispatch means we're clearing your property during and after the storm — you never have to call.",
      },
      {
        title: "Careful with your property",
        desc: "Professional drivers who protect your pavement, edges, and landscaping — no torn-up lawns in spring.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Because we keep a concentrated route around Watertown, our response times are fast. We clear during and after storms based on your trigger depth, prioritizing getting you out for work and getting businesses open on time.",
      },
      {
    ...
    blocks: [
      {
        ...
        body: [
          ...
          "We build ice control into commercial programs with defined service triggers and documentation, so you have a record that your property was treated. For homeowners who simply want a safe driveway and walk, on-demand and seasonal options are available too.",
        ],
      },
    ],
    faqs: [
      {
        ...
        a: "Yes. Commercial clients typically bundle salting into a seasonal contract with defined triggers and documented applications. On-demand salting is available for one-off freeze events or as-needed treatment for both commercial and residential properties.",
      },
      {
